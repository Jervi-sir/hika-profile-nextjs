    ...
    <div className="container px-4 mx-auto max-w-lg rounded-lg shadow-lg ">
      <div className="text-center">
        <p className="text-lg md:text-xl lg:text-2xl text-white leading-relaxed">
          Hi, I&apos;m <span className="font-bold text-indigo-800">Hika</span>, a video editor proficient in
        </p>
        <div className="flex justify-center items-center gap-2 mt-4 flex-wrap">
          ...
          <span className="font-bold text-indigo-800">Adobe Premiere Pro</span>
          ...
          <span className="font-bold text-indigo-800">After Effects</span>
        </div>
        <p className="text-lg md:text-xl lg:text-2xl text-white leading-relaxed mt-4">
          I speak 🗣️
          <span className="font-bold text-indigo-800"> English</span>, 
          <span className="font-bold text-indigo-800"> Arabic</span>, and 
          <span className="font-bold text-indigo-800"> French</span>
        </p>
